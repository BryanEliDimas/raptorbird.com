...
<body>
  ...
  <div class="container" style="margin-bottom: 30px; padding: 60px 0; line-height: 40px; font-weight: 200">
      <div class="row-fluid pagination-centered"> 

        <div class="span12" style="margin-bottom: 4em"> <!-- span12, page title -->

          <h1 id="white-border" style="font-size: 3.7em">Contact Us</h1>
        </div>
      ...
      <div class="row-fluid">
        ...
        <div class="span8 offset2 pagination-centered well well-small" style="color: black; font-size: 18px; font-weight: bold; background-color: white; padding: 1em">
